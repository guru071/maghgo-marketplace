...
const themes = [
  { name: 'Minimalist Fashion', description: 'Clean, elegant, white backgrounds', plan_required: 'basic', config: MINIMALIST_CONFIG as any },
  { name: 'Cyberpunk Electronics', description: 'Dark mode, neon accents, futuristic', plan_required: 'premium', config: CYBERPUNK_CONFIG as any },
  { name: 'Luxury Jewelry', description: 'Black and gold, premium imagery', plan_required: 'agency', config: LUXURY_CONFIG as any },
];
