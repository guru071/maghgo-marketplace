      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-6">
          ...
          <div className="space-y-3 mb-8">
            <a href={`https://wa.me/${whatsappNumber}?text=LOGIN`} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full bg-[#25D366] text-white py-3 rounded-full font-medium hover:bg-[#1DA851] transition-colors">
